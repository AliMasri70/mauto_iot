...
class GaugeConfigs extends StatefulWidget {
  const GaugeConfigs({super.key});

  @override
  State<GaugeConfigs> createState() => _GaugeConfigsState();
}

class _GaugeConfigsState extends State<GaugeConfigs> {
// final double _buttonHeight = 56.0;
  ...
  setLedWidget() async {
    ...
    LedModel model = LedModel(
      ...
      value: modelConn,
      gaugeData: valueData,
      gaugeDatamin: minVal.text,
      gaugeDatamax: maxVal.text,
    );

    Provider.of<WidgetModel>(context, listen: false).addGaugeWidget(model);
  }
