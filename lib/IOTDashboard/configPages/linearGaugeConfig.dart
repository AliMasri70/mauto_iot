...
class LinearGaugeConfig extends StatefulWidget {
  const LinearGaugeConfig({super.key});

  @override
  State<LinearGaugeConfig> createState() => _LinearGaugeConfigState();
}

class _LinearGaugeConfigState extends State<LinearGaugeConfig> {
// final double _buttonHeight = 56.0;
  ...
  setLedWidget() async {
    ...
    LedModel model = LedModel(
      ...
      value: modelConn,
      linearGuageData: valueData,
      linearGaugeDatamin: minVal.text,
      linearGaugeDatamax: maxVal.text,
    );

    Provider.of<WidgetModel>(context, listen: false)
        .addLinearGaugeWidget(model);
  }
