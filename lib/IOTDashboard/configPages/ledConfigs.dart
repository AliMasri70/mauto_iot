...
class LedConfigs extends StatefulWidget {
  const LedConfigs({super.key});

  @override
  State<LedConfigs> createState() => _LedConfigsState();
}

class _LedConfigsState extends State<LedConfigs> {
...
// final double _buttonHeight = 56.0;
  ...
  TextEditingController widgetName = TextEditingController(text: 'Led');
  ...
  setLedWidget() {
    LedModel model = LedModel(
      ...
      value: modelConn,
      offState:// LCDDigitalDisplay(value: "123"),
       const Icon(
                ...
                Row(
                  ...
                  children: [
                    ...
                    Center(
                      child: defaultText(
                          title:
                              " if  ${selectedVariable != 'Not Selected' ? selectedVariable : '??'}   ",
                          fontSize: 16,
                          TextColor: textGreyColor,
                          TextFontFamily: FontWeight.w400),
                    ),
